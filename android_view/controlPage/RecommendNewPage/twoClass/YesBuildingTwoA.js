        ...
        return (
            <View style={styles.contrainer}>
                ...
                <View style={styles.contrainerTab}>
                    <TableCon2  num={nums}  place={this.state.places}  status={this.state.statuses}  time={this.state.times}　operate={operates2} style={styles.containerTableCellBlue}></TableCon2>
                </View>
            </View>
        )
    }
