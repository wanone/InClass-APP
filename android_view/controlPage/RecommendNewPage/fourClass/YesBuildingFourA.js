        ...
        return (
            <View style={styles.contrainer}>
                ...
                <View style={styles.contrainerTab}>
                    <TableCon4  num={nums}  place={this.state.places}  status={this.state.statuses}  time={this.state.times}　operate={operates2} style={styles.containerTableCellBlue}></TableCon4>
                </View>
            </View>
        )
    }
